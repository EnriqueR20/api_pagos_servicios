...
class Payment_user(models.Model):
    usuarios = models.ForeignKey(User, on_delete =models.CASCADE, related_name='userss')
    servicios = models.ForeignKey(Services,on_delete =models.CASCADE, related_name='services')
...
class Expired_payments(models.Model):
    Payment_user_id = models.ForeignKey(Payment_user,on_delete =models.CASCADE, related_name='paymet_user')
